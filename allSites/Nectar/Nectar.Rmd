...
```{r inflorescence_plot, fig.height=9, fig.width=9, fig.cap="This plot shows the inflorescence for the nectar data across years and faceting the transects by grant excluding tall1a in 2017 for ncig sites. \\label{fig:inflorescence}"}
...
```{r richness_plot, fig.height=9, fig.width=9, fig.cap="This plot shows the richness for the nectar data across years and faceting the transects by grant. \\label{fig:richness}"}
