...
```{r inflorescence_plot, fig.height=9, fig.width=9, fig.cap="This plot shows the inflorescence for the nectar data across years and faceting the transects by grant. \\label{fig:inflorescence}"}
ggplot(d, aes(x=year, y=log(inflorescence))) + 
