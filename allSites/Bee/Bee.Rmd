...
bee %>% 
  ...
  as.data.frame %>%
    ...
    xtable(digits = c(0,0, rep(2,4)),
           caption=paste("2018 bumble bee: percent usage across all surveys"),
...
bee %>% 
  ...
  as.data.frame %>%
    ...
    xtable(digits = c(0,0, rep(2,5)),
           caption=paste("2018 honey bee: percent usage across all surveys"),
...
bee %>% 
  ...
  as.data.frame %>%
    ...
    xtable(digits = c(0,0, rep(2,6)),
           caption=paste("2018 solitary bee: percent usage across all surveys"),
