...
```{r nectar_yearly_plot, dependson="nectar_yearly_data",fig.cap="Nectar monthly caption"}
...
```{r nectar_heatmap, dependson="nectar_by_species",fig.height=8,fig.cap="Nectar heatmap"}
g <- ggplot(s %>%
              mutate(common_name = factor(common_name, 
                                          levels = rev(sort(unique(common_name))))), 
