...
```{r species}
nspecies = length(unique(nectar$`Nectar Plant Species`))
species1 = unique(nectar$`Nectar Plant Species`)[1:floor(nspecies/2)]
species2 = unique(nectar$`Nectar Plant Species`)[-c(1:floor(nspecies/2))]
```
...
nectar_table <- function(yr, flt, label, fntsz="small") {
  nectar %>%
...
nectar_table(2017, unique(nectar$`Nectar Plant Species`), 
             label = "nectar2017",
             fntsz="tiny")
# nectar_table(2018, species1, 
#              label = "nectar2018")
# nectar_table(2018, species2, 
#              label = "nectar2018")
...
nectar_density_table <- function(yr, flt, label, fntsz="small") {
nectar %>%
...
nectar_density_table(yr = 2017, flt = unique(nectar$`Nectar Plant Species`),
                     label = "density2017",
                     fntsz="tiny")
# nectar_density_table(yr = 2018, flt = species1,
#                      label = "density2018",
#                      fntsz="tiny")
# nectar_density_table(yr = 2018, flt = species2,
#                      label = "density2018",
#                      fntsz="tiny")
...
ramet_table(yr=2018, 
            flt=unique(ramet$`Nectar Plant Species`)[unique(ramet$`Nectar Plant Species`)!="milkweed strip: common milkweed ramet"], 
            label = "ramet2018")
```
...
ramet_density_table(yr=2018, 
                    flt=unique(ramet$`Nectar Plant Species`)[unique(ramet$`Nectar Plant Species`)!="milkweed strip: common milkweed ramet"], 
                    label = "density2018ramet")
```
