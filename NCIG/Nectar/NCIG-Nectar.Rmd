...
native_species = species %>% filter(native_introduced_both=="native") %>% pull(common_name)
intro_species = species %>% filter(native_introduced_both=="introduced") %>% pull(common_name)
both_species = species %>% filter(native_introduced_both=="both") %>% pull(common_name)
