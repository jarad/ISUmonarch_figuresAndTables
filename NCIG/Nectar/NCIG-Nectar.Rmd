...
\newpage
```{r nectar_heatmap, warning=FALSE, message=FALSE, fig.height=9, fig.width=9}
...
\newpage
```{r nectar_heatmap2_planted, warning=FALSE, message=FALSE, fig.height=9, fig.width=9}
...
\newpage
```{r nectar_heatmap2_non_planted, warning=FALSE, message=FALSE, fig.height=9, fig.width=9}
