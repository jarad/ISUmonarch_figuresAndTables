...
nectar_table <- function(yr, flt, label) {
  nectar %>%
    ...
    complete(siteID, round, fill = list(count = 0)) %>%
...
nectar_density_table(yr = 2016, flt = unique(nectar$`Nectar Plant Species`),
                     label = "density2016")
nectar_density_table(2017, unique(nectar$`Nectar Plant Species`),
                                   # c("milkweed strip: common milkweed ramet",
                                   #   "milkweed strip: common milkweed strip",
                                   #   "butterfly milkweed ramet",
                                   #   "common milkweed ramet",
...
```{r nectar_heatmap1, warning=FALSE, message=FALSE, fig.height=7, fig.width=9}
nectar_density_heatmap(2017, unique(nectar$`Nectar Plant Species`))
```
