---
title: "ISU Monarch Data Summary for Pork Sites"
...
Table \ref{t:nectar2016}, \ref{t:nectar2017}, and \ref{t:nectar2018} provide mean count of nectar plant species averaged across all data collection events. 
...
Table \ref{t:density2016}, \ref{t:density2017}, and \ref{t:density2018} provide nectar plant species density (per 100m2) averaged across all data collection events. 
Table \ref{t:density2017ramet} and \ref{t:density2018ramet} provides mean density of milkweed ramets.
Values in table represent the specific counting unit for each species, not necessarily a whole plant.
Figures \ref{fig:nectar_heatmap_planted_17}, \ref{fig:nectar_heatmap_planted_18}, \ref{fig:nectar_heatmap_non_planted_17}, \ref{fig:nectar_heatmap_non_planted_18}, and \ref{fig:ramet_heatmap_18} are heatmaps which plot the log density of species (planted and non-planted) with transects on the columns and species on the rows; transects are sorted by average density and species are sorted by average presence.
...
<!-- # ```{r nectar_heatmap_planted_16, warning=FALSE, message=FALSE, fig.height=9, fig.width=9, fig.cap="This plot is a heatmap for density of nectar species planted with transects on the columns and species on the rows sorting transects by average density and sorting species by avg presence for year 2016."} -->
<!-- # nectar_density_heatmap(yr = 2016, flt = unique(nectar$`Nectar Plant Species`), plnt="planted") -->
<!-- # ``` -->
